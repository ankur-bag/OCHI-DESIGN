...
const Footer = () => {
    return (
        <div data-scroll data-scroll-section data-scroll-speed= "-.1" className='w-full h-screen bg-black px-10 py-25 flex'>
            <div className='w-1/2 text-zinc-100 '>
                <h1 className='text-8xl font-["Bungee"] tracking-tighter'>eye- <br/>opening</h1>
            ...
            <div className='w-1/2 '>
                <h1 className='text-7xl font-["Bungee"] tracking-tighter'>PRESENTATIONS</h1>
                <div className='flex '>
                        <div className='dets flex flex-col w-2/3'>
                    <h1 className='mt-7 mb-3'>S:</h1>
                    <div className='dets2 flex flex-col'>
                    <a className= 'block text-lg font-light'href="#">Instagram</a>
                    <a className= 'block text-lg font-light'href="#">Behance</a>
                    <a className= 'block text-lg font-light'href="#">Meta</a>
                    <a className= 'block text-lg font-light'href="#">Linkedln</a>
                    </div>
                    <h1 className='mt-7 mb-3'>L:</h1>
                    <div className='dets2 flex flex-col'>
                    ...
                    <a className= 'block text-lg font-light mt-5'href="#">30 Chukarina St</a>
                ...
                <div className='w-1/3 px-15'>
                <h1 className='mt-50 mb-3'>M:</h1>
                    <div className='dets2 flex flex-col'>
                    <a className= 'block text-lg font-light'href="#">Home</a>
                    <a className= 'block text-lg font-light'href="#">Services</a>
                    <a className= 'block text-lg font-light mt-5'href="#">Our work</a>
